...
sudo ./run_snort.sh (I include all commands to that SCRIPT)
...
Finally, a report can be generated by executing sudo ./snort_report.py

This Python script converts text-based alerts into a structured PDF report.
